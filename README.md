...
Hosekeeper is a Home Assistant custom integration for looking after one or more lawns. Each
field gets its own diary of irrigation, rain, mowing, fertilizing and how the grass looked;
...
A **Hosekeeper** sidebar panel shows each lawn by day (what to do now, the water balance,
...
3. **Settings → Devices & services → Add integration → Hosekeeper**, once per field.
