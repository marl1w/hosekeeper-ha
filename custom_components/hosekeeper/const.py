...
# A lawn is one config entry; each zone of it is a subentry of that entry.
#
# The split is what a person would say out loud. Where the lawn is, what soil it sits on, what
# grows on it, when it was laid and what waters it are true of the whole turf and would be
# answered identically for every zone. How big a zone is, how much sun it gets, which valve
# opens it and what shades it are true of that zone alone.
ZONE_SUBENTRY: Final = "zone"
...
ROBOT_CADENCES: Final = ("frequent", "balanced", "gentle")
